...
Nutze exakt dieses Schema:
{
  ...
  "quizQuestion": "Eine leichte Frage - wahlweise zum Textinhalt, zum Bild (falls vorhanden) oder zu Gefühlen. Wechsle zwischen drei Fragetypen ab, nicht immer denselben: (1) Erinnern - was ist im Text/Bild gerade passiert/zu sehen; (2) Verstehen - warum ist das passiert, was fühlt eine Figur dabei; (3) Übertragen - eine Frage, die das Kind SELBST einbezieht, ausgehend vom Thema/Gefühl dieser Seite (z.B. 'Wann warst du selbst schon einmal traurig?'). Passend zur Rolle.",
...
\`\`\`persona:${p.id}
{
  ...
  "quizQuestion": "Eine leichte Frage - wahlweise zum Textinhalt, zum Bild (falls vorhanden) oder zu Gefühlen. Wechsle zwischen drei Fragetypen ab, nicht immer denselben: (1) Erinnern - was ist im Text/Bild gerade passiert/zu sehen; (2) Verstehen - warum ist das passiert, was fühlt eine Figur dabei; (3) Übertragen - eine Frage, die das Kind SELBST einbezieht, ausgehend vom Thema/Gefühl dieser Seite (z.B. 'Wann warst du selbst schon einmal traurig?'). Passend zur Rolle (${p.instruction}).",
  "quizAnswer": "Die kurze Antwort darauf.",
